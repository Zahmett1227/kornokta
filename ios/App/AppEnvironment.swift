...
extension DailyNewCardLedger {
    /// The original key, unchanged through the concept deck's rise and removal
    /// (2026-09-10 → 2026-09-14): the tally a user has already built up today
    /// survives an upgrade, instead of handing them a fresh allowance.

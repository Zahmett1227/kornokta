...
- Ders/konu şablonu: [`backend/schemas/subject_topics.json`](../backend/schemas/subject_topics.json)
  — 11 ders, 143 konu. Kart sınıflandırmasının, Bilgi Haritası'nın ve Egzersiz
  filtresinin **ortak kapalı kümesi**. Kimlik daima (ders, konu) çiftidir: altı
  konu adı iki ders altında birden geçer.

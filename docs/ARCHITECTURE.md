...
> **"Kapsama" bu repoda iki ayrı şeydir; karıştırmayın.**
>
> | | Kapsama sözleşmesi (#47) | Karanlık Harita (ADR-009) |
> |---|---|---|
> | Ölçek | **tek sayfa** | **tüm deste** |
> | Soru | bu sayfadaki işaretlerden hangisi kartlaşmadı? | 143 kanonik konudan hangisinde hiç kart yok? |
> | Birim | işaret ↔ kart | konu ↔ kart |
> | Kod | `providers/coverage.ts`, `Models/Coverage.swift` | `providers/topicCoverage.ts`, `Models/DarkMapCoverage.swift` |
>
> İkisi kardeş: aynı hatanın (üretilmemiş kart hiçbir sinyal taşımaz) iki farklı
> ölçeğini kapatıyorlar. Sayfa ölçeğini #47, müfredat ölçeğini bu kapatır.
